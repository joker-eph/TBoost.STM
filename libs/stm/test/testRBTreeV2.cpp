...
static nRedBlackTreeV2::RedBlackTree<int> *rbTree = NULL;
...
///////////////////////////////////////////////////////////////////////////////
void* TestRedBlackTreeV2Inserts(void *threadId)
{
...
void TestRedBlackTreeV2WithMultipleThreads()
{
   ...
   rbTree = new nRedBlackTreeV2::RedBlackTree<int>;
   ...
   {
      threadId[j] = j;
      pthread_create(&threads[j], NULL, TestRedBlackTreeV2Inserts, (void *)&threadId[j]);
   }

   int mainThreadId = kMaxThreads-1;

   TestRedBlackTreeV2Inserts((void*)&mainThreadId);
   ...
   int totalInserts = rbTree->node_count();
