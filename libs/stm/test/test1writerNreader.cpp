...
LinkedList< list_node_type > *writerList = NULL;
...
///////////////////////////////////////////////////////////////////////////////
static void* Test1writerNreaders(void *threadId)
{
...
void Test1writerNreadersWithMultipleThreads()
{
   ...
   writerList = new LinkedList<list_node_type>;
   ...
   {
      threadId[j] = j;
      pthread_create(&threads[j], NULL, Test1writerNreaders, (void *)&threadId[j]);
   }

   int mainThreadId = kMaxThreads-1;

   Test1writerNreaders((void*)&mainThreadId);
   ...
   int totalInserts = writerList->walk_size();
   ...
   cout << "DEL_INVAL_";
#endif
   cout << "1W/NR: DSTM_" << transaction::update_policy_string() << "   ";
