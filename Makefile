...
SOURCES=$(SRC)/contention_manager.cpp $(SRC)/transaction.cpp $(SRC)/bloom_filter.cpp $(TESTS)/globalIntArr.cpp $(TESTS)/irrevocableInt.cpp $(TESTS)/isolatedComposedIntLockInTx2.cpp $(TESTS)/isolatedComposedIntLockInTx.cpp $(TESTS)/isolatedInt.cpp $(TESTS)/isolatedIntLockInTx.cpp $(TESTS)/litExample.cpp $(TESTS)/lotExample.cpp $(TESTS)/nestedTxs.cpp $(TESTS)/smart.cpp $(TESTS)/stm.cpp $(TESTS)/testHashMap.cpp $(TESTS)/testHashMapAndLinkedListsWithLocks.cpp $(TESTS)/testHashMapWithLocks.cpp $(TESTS)/testHT_latm.cpp $(TESTS)/testInt.cpp $(TESTS)/testLinkedList.cpp $(TESTS)/test1writerNreader.cpp $(TESTS)/testLinkedListWithLocks.cpp $(TESTS)/testLL_latm.cpp $(TESTS)/testPerson.cpp $(TESTS)/testRBTree.cpp $(TESTS)/transferFun.cpp $(TESTS)/txLinearLock.cpp $(TESTS)/usingLockTx.cpp $(TESTS)/testatom.cpp $(TESTS)/pointer_test.cpp $(TESTS)/testEmbedded.cpp $(TESTS)/testBufferedDelete.cpp
